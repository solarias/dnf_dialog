...
title = "제국의 첩자";//던전 명칭┏ 0 : 이미지만 //1 : 아래 고정 //2 : 위 고정┏ number : 상대적 이동 / array : 선택 이동
...
["알베르트","","","구 시가지에서 가까운 곳이니까 검은 악몽에 관해서도 조사할 수 있지 않을까? 샛길을 가르쳐 줄 테니 갔다와봐.",,"","",""],
["하츠","back020001","","알겠어요. 가보도록 할게요.",,"","",""],
["","back020500","0","",,"","",""],
...
["하츠","","","(굉장히 단도직입적인 사람이로군...)혼쭐을 낼 사람이라면 레지스탕스를 말하는 건가요?",,"","",""],
...
["하츠","","","흠. 제국도 검은 악몽의 피해를 막기 위해 애쓰고 있다는... 그런 이야기는 아닌 것 같군요, 역시.",,"","",""],
["로엘","","","그럴 놈돌이 아니다! 그놈들은 포악한 놈들이다. 늘 주의하고 조심해라. 이 경고를 해주고 싶었다.",,"","",""],
["하츠","","","그런데 왜 나한테 그런 애기를 하죠? 저기 서있는 제국 기사한테 고자질을 히면 당장에 당신을 잡아가둘 텐데.",,"","",""],
["로엘","","","엥!? 너 제국 가사랑 싸웠잖아. 제국 싫어하는 거 아냐?",,"","",""],
["하츠","","","(단순하달까, 순진하달까...) 뭐, 확실히 제국이랑 협조할 생각은 없긴 해요.",,"","",""],
["로엘","","","하하하! 당연하지! 내가 눈여겨 본 녀석인데! 그럼 제국 놈들에게 정보를 빼앗기지 않도록 잘 움직이라고!",,"","",""],
["하츠","","","(제국군은 검은 악몽으로 무언가를 할 생각인가... 하긴 단순히 주민 보호를 하는 것으로는 보이지 않았어.)",,"","",""],
["하츠","back020005","","(제국군은 아직 그 마을에 대해 모를 테니 들이닥차기 전에 먼저 조사를 해볼까.)",,"","",""],
["하츠","back020000","2","(석상들은 아무래도 검은 악몽과 직접적으로 관련이 있는 것 같진 않군... 이전까지 공통적으로 느꼈던 수상한 기운이 느껴지지 않아.)",,"","",""],
["하츠","","","(그럼 누가 조종하고 있는 건가? 어찌면 암므 때와 마찬가지로...)",,"","",""],
["병아리","back020000","","또 네놈인가. 생쥐처럼 바쁘게 잘도 돌아다니는군.",,"","",""],
["병아리","back020003","1","네놈이 어디서 무얼하든 관여하지 않겠다고는 했지만 허튼 생각을 하고 있어서는 곤란하다.",,"","",""],
["병아리","","","최근 제국에 반항하는 불순한 무리들이 활개를 차고 다닌다고 한다. 그에 대해 들은 바가 있으면 당장 불어라.",,"","",""],
["하츠","","","부탁하는 입장에서 엄청 잘난 태도네. 난 들은 거 없어. 있다고 해도 당신한텐 말하기 싫어지는군.",,"","",""],
["레니","","","이 녀석이 어디서... 부단장남께 말버릇이 그게 뭐냐!",,"","",""],
["병아리","","","네놈이야말로 닥쳐라.",,"","",""],
["병아리","","","모험가. 네놈이 시궁창의 쥐가 되는 것은 자유다. 그러나 나의 적으로 설 생각은 하지 않는 것이 그 비루한 명줄을 이어가는 길일 거다.",,"","",""],
["하츠","","","(이 숨도 못 쉴 것 같은 살기... 진짜다. 정말 꼬투리라도 잡히면 큰일 나겠어.)",,"","",""],
["하츠","back020003","","... 제국이든 뭐든 상관 없어. 나는 그저 내 목적을 위해 모험 중이니까 방해나 하지 말아줘.",,"","",""],
["하츠","back020502","1","휴우. 겨우 떨쳐냈나...",,"","",""],
...
["하츠","","","레지스탕스에 가입해서 제국에 반기를 들라는 건가요?",,"","",""],
["하츠","","","확실히 제국군이 하는 짓은 마음에 들지 않아요. 하지만 굳이 레지스탕스에 들어서 귀찮은 일에 휘말리는 건 사양하고 싶군요.",,"","",""],
...
["하츠","","","오늘은 다른 이야기 때문에 왔어요. 세인트혼의 선장 루터가 여기로 오라고 해서 왔습니다만...",,"","",""],
["슈시아","","","어머나, 당신이...",,"","",""],
...
["하츠","","","아, 여기가 옛 헨돈마이어 부근이라면 분명 벨마이어 공국의 수도... 그런데 왜 숨어계시는 거죠? 제국이 점점 벨마이어령을 침범해 오고 있다던데 밖으로 나와서 대항해야하는 게 아닌가요?",,"","",""],
["루터","","","지금 우리 힘으로는 제국의 암살자를 막을 수가 없기 때문이지.",,"","",""],
["루터","","","미안하군. 자네와 헤어진 후 계속 뒤를 밟고 있었어. 권유해 온 주제에 미안하지만 제국에 고해바치면 곤란하니까.",,"","",""],
["하츠","","","그렇군요. 그럼 0|제 저한테서 뭘 바라는 거죠?",,"","",""],
["루터","","","계속 모험을 해주길 바라네. 말했잖아? 당장 레지스탕스에 들어오지 않아도 좋다고. 자네만 좋다면, 제국 편으로 배신하지 않는 한 서포트틀 할 생각일세.",,"","",""],
["하츠","","","실력 있는 모험가를 키워서 아군으로 만들 생각인가요? 적으로 돌아설 수도 있을 텐데.",,"","",""],
["스카디","","","그런 위험은 이미 각오하고 있습니다. 하지만 제국의 속셈을 알게 된다면 적어도 적이 되실 분은 적을 거라고 생각합니다.",,"","",""],
["하츠","","","그런가요? 흠. 여왕님께 무례하게 들릴 수도 있겠지만 그쪽이 저를 시험해본다면, 저도 그쪽을 시험해보고 싶군요.",,"","",""],
["하츠","","","캡틴 루터와 만난 그곳의 비밀을 알아내고 싶어요. 도와주실 수 있나요?",,"","",""],
...
["하츠","","","(이런 곳에 숨어있는 중에도 기품을 잃지 않던 여성이 슬퍼하는 모습을 보면서 정말로 이 사람이 한 나라의 여왕일 거라고 믿게 되었다.)",,"","",""],
